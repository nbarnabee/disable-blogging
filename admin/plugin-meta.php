...
class Fact_Maven_Disable_Blogging {
    ...
    public function plugin_row_meta( $links, $file ) {
        ...
        if ( strpos( $file, 'disable-blogging/disable-blogging.php' ) !== FALSE ) {
            $meta = array(
                ...
                'review' => '<a href="https://wordpress.org/support/plugin/disable-blogging/reviews/#new-post" target="_blank"><span class="dashicons dashicons-thumbs-up"></span> ' . __( 'Review', 'dsbl' ) . '</a>',
    ...
    public function plugin_action_links( $links, $file ) {
        ...
        if ( $file == 'disable-blogging/disable-blogging.php' && current_user_can( 'manage_options' ) ) {
            array_unshift(
                $links,
                '<a href="options-general.php?page=blogging">' . __( 'Settings', 'dsbl' ) . '</a>'
            );
        }
